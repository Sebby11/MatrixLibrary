...
//October 26, 2019                       FIlename: Matrix.h
...
typedef struct EntryObj{
  int column;// column
  double value;// double value in matrix
} EntryObj;

typedef EntryObj* Entry;

//B: how do i set up MatrixObj 
//B: how can i set the size of the array to be used in newMatrix
